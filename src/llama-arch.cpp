...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    // Qwen3-Omni Talker keys
    { LLM_KV_TALKER_THINKER_HIDDEN_SIZE, "%s.talker.thinker_hidden_size" },
...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
    ...
    {
        LLM_ARCH_QWEN3OMNI_TALKER,
        {
            // Main Talker transformer (20 MoE layers)
            { LLM_TENSOR_TOKEN_EMBD,                "token_embd" },
            { LLM_TENSOR_OUTPUT_NORM,               "output_norm" },
            { LLM_TENSOR_OUTPUT,                    "output" },
            { LLM_TENSOR_ATTN_NORM,                 "blk.%d.attn_norm" },
            ...
            { LLM_TENSOR_TALKER_TEXT_PROJ_FC1,      "talker.text_projection.fc1" },
            { LLM_TENSOR_TALKER_TEXT_PROJ_FC2,      "talker.text_projection.fc2" },
            { LLM_TENSOR_TALKER_HIDDEN_PROJ_FC1,    "talker.hidden_projection.fc1" },
            { LLM_TENSOR_TALKER_HIDDEN_PROJ_FC2,    "talker.hidden_projection.fc2" },
            { LLM_TENSOR_TALKER_CODEC_HEAD,         "talker.codec_head" },
            { LLM_TENSOR_TALKER_CODEC_EMBD,         "talker.codec_embeddings.%d" },
            // Talker Code Predictor (5-layer transformer)
            { LLM_TENSOR_TALKER_CP_CODEC_EMBD,      "talker.code_predictor.codec_embeddings.%d" },
            { LLM_TENSOR_TALKER_CP_ATTN_Q,          "talker.code_predictor.blk.%d.attn_q" },
            { LLM_TENSOR_TALKER_CP_ATTN_K,          "talker.code_predictor.blk.%d.attn_k" },
            { LLM_TENSOR_TALKER_CP_ATTN_V,          "talker.code_predictor.blk.%d.attn_v" },
            { LLM_TENSOR_TALKER_CP_ATTN_OUT,        "talker.code_predictor.blk.%d.attn_out" },
            { LLM_TENSOR_TALKER_CP_ATTN_Q_NORM,     "talker.code_predictor.blk.%d.attn_q_norm" },
            { LLM_TENSOR_TALKER_CP_ATTN_K_NORM,     "talker.code_predictor.blk.%d.attn_k_norm" },
            { LLM_TENSOR_TALKER_CP_ATTN_NORM,       "talker.code_predictor.blk.%d.attn_norm" },
            { LLM_TENSOR_TALKER_CP_FFN_GATE,        "talker.code_predictor.blk.%d.ffn_gate" },
            { LLM_TENSOR_TALKER_CP_FFN_UP,          "talker.code_predictor.blk.%d.ffn_up" },
            { LLM_TENSOR_TALKER_CP_FFN_DOWN,        "talker.code_predictor.blk.%d.ffn_down" },
            { LLM_TENSOR_TALKER_CP_FFN_NORM,        "talker.code_predictor.blk.%d.ffn_norm" },
            { LLM_TENSOR_TALKER_CP_OUTPUT_NORM,     "talker.code_predictor.output_norm" },
            { LLM_TENSOR_TALKER_CP_LM_HEAD,         "talker.code_predictor.lm_head.%d" },
            // Code2Wav HiFi-GAN vocoder
            { LLM_TENSOR_C2W_CODE_EMBD,             "code2wav.code_embd" },
            { LLM_TENSOR_C2W_PRE_ATTN_Q,            "code2wav.pre.blk.%d.attn_q" },
            { LLM_TENSOR_C2W_PRE_ATTN_K,            "code2wav.pre.blk.%d.attn_k" },
            { LLM_TENSOR_C2W_PRE_ATTN_V,            "code2wav.pre.blk.%d.attn_v" },
            { LLM_TENSOR_C2W_PRE_ATTN_OUT,          "code2wav.pre.blk.%d.attn_out" },
            { LLM_TENSOR_C2W_PRE_ATTN_NORM,         "code2wav.pre.blk.%d.attn_norm" },
            { LLM_TENSOR_C2W_PRE_FFN_GATE,          "code2wav.pre.blk.%d.ffn_gate" },
            { LLM_TENSOR_C2W_PRE_FFN_UP,            "code2wav.pre.blk.%d.ffn_up" },
            { LLM_TENSOR_C2W_PRE_FFN_DOWN,          "code2wav.pre.blk.%d.ffn_down" },
            { LLM_TENSOR_C2W_PRE_FFN_NORM,          "code2wav.pre.blk.%d.ffn_norm" },
            { LLM_TENSOR_C2W_PRE_ATTN_SCALE,        "code2wav.pre.blk.%d.attn_scale" },
            { LLM_TENSOR_C2W_PRE_FFN_SCALE,         "code2wav.pre.blk.%d.ffn_scale" },
            { LLM_TENSOR_C2W_PRE_OUTPUT_NORM,       "code2wav.pre.output_norm" },
            { LLM_TENSOR_C2W_UP_CONV,               "code2wav.up.%d.conv" },
            { LLM_TENSOR_C2W_UP_DWCONV,             "code2wav.up.%d.dwconv" },
            { LLM_TENSOR_C2W_UP_NORM,               "code2wav.up.%d.norm" },
            { LLM_TENSOR_C2W_UP_PWCONV1,            "code2wav.up.%d.pwconv1" },
            { LLM_TENSOR_C2W_UP_PWCONV2,            "code2wav.up.%d.pwconv2" },
            { LLM_TENSOR_C2W_UP_GAMMA,              "code2wav.up.%d.gamma" },
            { LLM_TENSOR_C2W_UP_CONV_B,             "code2wav.up.%d.conv.bias" },
            { LLM_TENSOR_C2W_UP_DWCONV_B,           "code2wav.up.%d.dwconv.bias" },
            { LLM_TENSOR_C2W_UP_NORM_B,             "code2wav.up.%d.norm.bias" },
            { LLM_TENSOR_C2W_UP_PWCONV1_B,          "code2wav.up.%d.pwconv1.bias" },
            { LLM_TENSOR_C2W_UP_PWCONV2_B,          "code2wav.up.%d.pwconv2.bias" },
            { LLM_TENSOR_C2W_DEC_CONV_IN,           "code2wav.dec.conv_in" },
            { LLM_TENSOR_C2W_DEC_CONV_IN_B,         "code2wav.dec.conv_in.bias" },
            { LLM_TENSOR_C2W_DEC_SNAKE_ALPHA,       "code2wav.dec.%d.snake_alpha" },
            { LLM_TENSOR_C2W_DEC_SNAKE_BETA,        "code2wav.dec.%d.snake_beta" },
            { LLM_TENSOR_C2W_DEC_UPSAMPLE,          "code2wav.dec.%d.upsample" },
            { LLM_TENSOR_C2W_DEC_UPSAMPLE_B,        "code2wav.dec.%d.upsample.bias" },
            { LLM_TENSOR_C2W_DEC_BLK_SNAKE_A,       "code2wav.dec_blk.%d.snake_alpha" },
            { LLM_TENSOR_C2W_DEC_BLK_SNAKE_B,       "code2wav.dec_blk.%d.snake_beta" },
            { LLM_TENSOR_C2W_DEC_BLK_CONV,          "code2wav.dec_blk.%d.conv" },
            { LLM_TENSOR_C2W_DEC_BLK_CONV1,         "code2wav.dec_blk.%d.conv1" },
            { LLM_TENSOR_C2W_DEC_BLK_CONV2,         "code2wav.dec_blk.%d.conv2" },
            { LLM_TENSOR_C2W_DEC_BLK_ACT1_A,        "code2wav.dec_blk.%d.act1_alpha" },
            { LLM_TENSOR_C2W_DEC_BLK_ACT1_B,        "code2wav.dec_blk.%d.act1_beta" },
            { LLM_TENSOR_C2W_DEC_BLK_ACT2_A,        "code2wav.dec_blk.%d.act2_alpha" },
            { LLM_TENSOR_C2W_DEC_BLK_ACT2_B,        "code2wav.dec_blk.%d.act2_beta" },
            { LLM_TENSOR_C2W_DEC_FINAL_SNAKE_A,     "code2wav.dec.final_snake_alpha" },
            { LLM_TENSOR_C2W_DEC_FINAL_SNAKE_B,     "code2wav.dec.final_snake_beta" },
            { LLM_TENSOR_C2W_DEC_CONV_OUT,          "code2wav.dec.conv_out" },
        },
    },
    {
        LLM_ARCH_QWEN3OMNIMOE,
        {
            // Qwen3-Omni Thinker (Qwen3MOE + M-RoPE + shared experts)
            { LLM_TENSOR_TOKEN_EMBD,         "token_embd" },
            { LLM_TENSOR_OUTPUT_NORM,        "output_norm" },
            { LLM_TENSOR_OUTPUT,             "output" },
            { LLM_TENSOR_ATTN_NORM,          "blk.%d.attn_norm" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    // Qwen3-Omni Talker tensors
    {LLM_TENSOR_TALKER_TEXT_PROJ_FC1,       {LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_TEXT_PROJ_FC2,       {LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_HIDDEN_PROJ_FC1,     {LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_HIDDEN_PROJ_FC2,     {LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CODEC_HEAD,          {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CODEC_EMBD,          {LLM_TENSOR_LAYER_INPUT, GGML_OP_GET_ROWS}},
    // Talker Code Predictor
    // Codec embeddings and LM heads are indexed (0-15 for embeddings, 0-14 for heads)
    {LLM_TENSOR_TALKER_CP_CODEC_EMBD,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_GET_ROWS}},
    {LLM_TENSOR_TALKER_CP_ATTN_Q,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CP_ATTN_K,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CP_ATTN_V,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CP_ATTN_OUT,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CP_ATTN_Q_NORM,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_TALKER_CP_ATTN_K_NORM,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_TALKER_CP_ATTN_NORM,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_TALKER_CP_FFN_GATE,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CP_FFN_UP,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CP_FFN_DOWN,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_TALKER_CP_FFN_NORM,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_TALKER_CP_OUTPUT_NORM,      {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_TALKER_CP_LM_HEAD,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    // Code2Wav vocoder
    {LLM_TENSOR_C2W_CODE_EMBD,              {LLM_TENSOR_LAYER_INPUT, GGML_OP_GET_ROWS}},
    {LLM_TENSOR_C2W_PRE_ATTN_Q,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_PRE_ATTN_K,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_PRE_ATTN_V,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_PRE_ATTN_OUT,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_PRE_ATTN_NORM,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_PRE_FFN_GATE,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_PRE_FFN_UP,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_PRE_FFN_DOWN,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_PRE_FFN_NORM,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_PRE_ATTN_SCALE,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_PRE_FFN_SCALE,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_PRE_OUTPUT_NORM,        {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_UP_CONV,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_UP_DWCONV,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_UP_NORM,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_UP_PWCONV1,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_UP_PWCONV2,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_UP_GAMMA,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_CONV_IN,            {LLM_TENSOR_LAYER_INPUT, GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_DEC_CONV_IN_B,          {LLM_TENSOR_LAYER_INPUT, GGML_OP_ADD}},
    {LLM_TENSOR_C2W_DEC_SNAKE_ALPHA,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_SNAKE_BETA,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_UPSAMPLE,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_DEC_UPSAMPLE_B,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_C2W_DEC_BLK_SNAKE_A,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_BLK_SNAKE_B,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_BLK_CONV,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_DEC_BLK_CONV1,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_DEC_BLK_CONV2,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_DEC_BLK_ACT1_A,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_BLK_ACT1_B,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_BLK_ACT2_A,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_BLK_ACT2_B,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_FINAL_SNAKE_A,      {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_FINAL_SNAKE_B,      {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_DEC_CONV_OUT,           {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_IM2COL}},
};
