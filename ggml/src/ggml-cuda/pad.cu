...
template <typename T>
static __global__ void pad_t(const T * src, size_t s00, size_t s01, size_t s02, size_t s03, T * dst,
...
static void pad_cuda(const T * src, size_t s00, size_t s01, size_t s02, size_t s03, T * dst,
    ...
    pad_t<T><<<gridDim, CUDA_PAD_BLOCK_SIZE, 0, stream>>>(src, s00, s01, s02, s03, dst,
