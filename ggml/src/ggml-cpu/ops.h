...
void ggml_compute_forward_dsv4_lid_topk(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_dsv4_lid_union(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_dsv4_lid_memb(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_dsv4_fa_merge(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_hc_scatter_add(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_hc_gate_mix(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_hc_mix_down(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_hc_mix_up(const struct ggml_compute_params * params, struct ggml_tensor * dst);
